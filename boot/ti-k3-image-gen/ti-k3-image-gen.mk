...
# HS variants have an -enc on the end of the sysfw filename
ifneq ($(findstring hs,$(TI_K3_IMAGE_GEN_SECTYPE)),)
TI_K3_IMAGE_GEN_ENC = -enc
endif

TI_K3_IMAGE_GEN_SYSFW = $(TI_K3_IMAGE_GEN_FW_TYPE)-firmware-$(TI_K3_IMAGE_GEN_SOC)-$(TI_K3_IMAGE_GEN_SECTYPE)$(TI_K3_IMAGE_GEN_ENC).bin
